...
//lwzAdd
- (void)setImagePositionWithType:(SSImagePositionType)type spacing:(CGFloat)spacing forState:(UIControlState)state{
    CGSize imageSize = [self imageForState:state].size;
    CGSize titleSize = SS_SINGLELINE_TEXTSIZE([self titleForState:state], self.titleLabel.font);
