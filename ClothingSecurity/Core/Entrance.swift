...
class Entrance: NSObject {
    @objc class func entrance() -> ESTabBarController{
        ...
        contentController.tabBarItem = ESTabBarItem(title: localizedString("mainPage"), image: imageNamed("ic_firstPage"), selectedImage: imageNamed("ic_firstPage_select"))
        ...
        discoverController.tabBarItem = ESTabBarItem(title: localizedString("discover"), image: imageNamed("ic_discover"), selectedImage: imageNamed("ic_discover_select"))
        ...
        clothController.tabBarItem = ESTabBarItem(title: localizedString("scan"), image: imageNamed("ic_security"), selectedImage: imageNamed("ic_security_select"))
        ...
        personalController.tabBarItem = ESTabBarItem(title: localizedString("Mine"), image: imageNamed("ic_personal"), selectedImage: imageNamed("ic_personal_select"))
