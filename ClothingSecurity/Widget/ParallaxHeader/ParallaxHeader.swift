...
class ParallaxView: UIView {
    ...
    override func removeFromSuperview() {
        ...
        if let observe = observe {
            scrollView.removeObserver(observe, forKeyPath: NSStringFromSelector(
    ...
    override func didMoveToSuperview() {
        ...
        observe = scrollView.observe(\.contentOffset, options: .new, changeHandler: { (_, _) in
            self.parent.layoutContentView()
        })
    }
}
...
public class ParallaxHeader: NSObject {
    ...
    func layoutContentView() {
        ...
        let relativeHeight = -relativeYOffset + offsetPadding
