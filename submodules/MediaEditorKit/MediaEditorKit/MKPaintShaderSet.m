...
@implementation MKPaintShaderSet
...
+ (NSDictionary *)setup
{
    ...
    for (NSString *key in shaderSet.keyEnumerator)
    {
        ...
        MKPaintShader *shader = [[MKPaintShader alloc] initWithVertexShader:vertex fragmentShader:fragment attributes:attributes uniforms:uniforms];
        shaders[key] = shader;
    }
