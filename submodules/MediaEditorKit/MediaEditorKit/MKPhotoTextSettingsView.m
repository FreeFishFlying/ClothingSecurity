...
@interface MKPhotoTextSettingsView ()
{
    NSArray *_fonts;
...
@implementation MKPhotoTextSettingsView

@synthesize interfaceOrientation = _interfaceOrientation;

- (instancetype)initWithFonts:(NSArray *)fonts selectedFont:(MKPhotoPaintFont *)__unused selectedFont selectedStroke:(bool)selectedStroke
{
...
- (void)setFont:(MKPhotoPaintFont *)__unused font
{
