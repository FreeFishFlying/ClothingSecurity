...
@interface MKPhotoEditorSliderView () <UIGestureRecognizerDelegate>
{
...
@implementation MKPhotoEditorSliderView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _backColor = [MKPhotoEditorInterfaceAssets sliderBackColor];
        _trackColor = [MKPhotoEditorInterfaceAssets sliderTrackColor];
        _startColor = [MKPhotoEditorInterfaceAssets sliderTrackColor];
