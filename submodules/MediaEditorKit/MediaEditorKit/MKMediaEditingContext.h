...
@protocol MKMediaEditAdjustments <NSObject>
...
@property (nonatomic, readonly) MKPaintingData *paintingData;
...
@interface MKMediaEditingContext : NSObject
...
- (NSObject<MKMediaEditAdjustments> *)adjustmentsForItem:(NSObject<TGMediaEditableItem> *)item;
- (SSignal *)adjustmentsSignalForItem:(NSObject<TGMediaEditableItem> *)item;
- (void)setAdjustments:(NSObject<MKMediaEditAdjustments> *)adjustments forItem:(NSObject<TGMediaEditableItem> *)item;
