...
@implementation MKVideoEditAdjustments
...
{
    MKVideoEditAdjustments *adjustments = [[[self class] alloc] init];
...
+ (instancetype)editAdjustmentsWithDictionary:(NSDictionary *)dictionary
{
    ...
    if (dictionary[@"paintingImagePath"])
        adjustments->_paintingData = [MKPaintingData dataWithPaintingImagePath:dictionary[@"paintingImagePath"]];
...
- (bool)isCropEqualWith:(id<MKMediaEditAdjustments>)adjusments
{
...
{
    return (_CGRectEqualToRectWithEpsilon(self.cropRect, adjustments.cropRect, [self _cropRectEpsilon])) && self.cropOrientation == ((MKVideoEditAdjustments *)adjustments).cropOrientation;
}
...
- (BOOL)isEqual:(id)object
{
    ...
    MKVideoEditAdjustments *adjustments = (MKVideoEditAdjustments *)object;
