...
@implementation MKPhotoEditorButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        dispatch_once(&onceToken, ^
        {
            ...
            CGContextSetFillColorWithColor(context, [MKPhotoEditorInterfaceAssets editorButtonSelectionBackgroundColor].CGColor);
...
- (void)setIconImage:(UIImage *)image activeIconImage:(UIImage *)activeIconImage
{
    ...
    CGContextSetFillColorWithColor(context, [MKPhotoEditorInterfaceAssets toolbarSelectedIconColor].CGColor);
...
- (UIImage *)_activeIconImage
{
    if (_activeIconImage == nil)
    {
        ...
        CGContextSetBlendMode (context, kCGBlendModeSourceAtop);
        CGContextSetFillColorWithColor(context, [MKPhotoEditorInterfaceAssets toolbarAppliedIconColor].CGColor);
