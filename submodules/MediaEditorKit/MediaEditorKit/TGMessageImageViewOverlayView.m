...
- (void)drawInContext:(CGContextRef)context
{
    ...
    switch (_type)
    {
        case TGMessageImageViewOverlayViewTypeDownload:
        {
            ...
            {
                CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0xffffffff, 0.8f).CGColor);
                CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
            }
            else if (_overlayStyle == TGMessageImageViewOverlayStyleAccent)
            {
                CGContextSetStrokeColorWithColor(context, MKColorWithHex(0xeaeaea).CGColor);
            ...
            {
                CGContextSetFillColorWithColor(context, MKAccentColor().CGColor);
                CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
            }
            else if (_overlayStyle == TGMessageImageViewOverlayStyleOutgoing)
            {
                CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0x3fc33b, 1.0f).CGColor);
                CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
            }
            
            if (_overlayStyle == TGMessageImageViewOverlayStyleDefault)
                CGContextSetStrokeColorWithColor(context, MKColorWithHexAndAlpha(0xff000000, 0.55f).CGColor);
            else if (_overlayStyle == TGMessageImageViewOverlayStyleIncoming) {
                if (true || ABS(diameter - 37.0f) < 0.1) {
                    CGContextSetStrokeColorWithColor(context, [UIColor clearColor].CGColor);
                } else {
                    CGContextSetStrokeColorWithColor(context, MKColorWithHex(0x4f9ef3).CGColor);
                }
            }
            else if (_overlayStyle == TGMessageImageViewOverlayStyleOutgoing) {
                if (true || ABS(diameter - 37.0f) < 0.1) {
                    ...
                    CGContextSetStrokeColorWithColor(context, MKColorWithHex(0x64b15e).CGColor);
                }
            }
            else
                CGContextSetStrokeColorWithColor(context, MKAccentColor().CGColor);
            ...
            if (_overlayStyle == TGMessageImageViewOverlayStyleDefault)
            {
                ...
                CGContextSetStrokeColorWithColor(context, MKColorWithHexAndAlpha(0x000000, 0.55f).CGColor);
                CGContextStrokeLineSegments(context, arrowLine, sizeof(arrowLine) / sizeof(arrowLine[0]));
        ...
        case TGMessageImageViewOverlayViewTypeProgressNoCancel:
        {
            ...
            if (_overlayStyle == TGMessageImageViewOverlayStyleDefault)
            {
                if (_overlayBackgroundColorHint != nil)
                    ...
                    CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0x000000, 0.7f).CGColor);
            ...
            else if (_overlayStyle == TGMessageImageViewOverlayStyleIncoming)
            {
                if (true || ABS(diameter - 37.0f) < 0.1) {
                    ...
                    CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0x85baf2, 0.15f).CGColor);
                }
                CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
            }
            else if (_overlayStyle == TGMessageImageViewOverlayStyleOutgoing)
            {
                if (true || ABS(diameter - 37.0f) < 0.1) {
                    CGContextSetFillColorWithColor(context, MKColorWithHex(0x3fc33b).CGColor);
                } else {
                    CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0x4fb212, 0.15f).CGColor);
                }
                CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
            }
            else if (_overlayStyle == TGMessageImageViewOverlayStyleAccent)
            ...
            if (_overlayStyle == TGMessageImageViewOverlayStyleDefault)
                ...
                if (true || ABS(diameter - 37.0f) < 0.1) {
                    CGContextSetStrokeColorWithColor(context, MKColorWithHex(0xe1ffc7).CGColor);
                } else {
                    CGContextSetStrokeColorWithColor(context, MKColorWithHex(0x64b15e).CGColor);
                }
            }
            ...
            {
                CGContextSetBlendMode(context, kCGBlendModeNormal);
                CGContextSetStrokeColorWithColor(context, MKColorWithHexAndAlpha(0xffffff, 1.0f).CGColor);
                if (_type == TGMessageImageViewOverlayViewTypeProgressCancel)
                    CGContextStrokeLineSegments(context, crossLine, sizeof(crossLine) / sizeof(crossLine[0]));
            }
        ...
        case TGMessageImageViewOverlayViewTypePlay:
        {
            ...
            CGFloat alpha = 0.8f;
            UIColor *iconColor = MKColorWithHexAndAlpha(0xff000000, 0.45f);
            if (diameter <= 25.0f + FLT_EPSILON) {
                offset = round(50.0f * 0.06f) - 1.0f;
                verticalOffset += 0.5f;
                alpha = 1.0f;
                iconColor = MKColorWithHex(0x434344);
            }
            ...
            {
                CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0xffffffff, alpha).CGColor);
                CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
        ...
        case TGMessageImageViewOverlayViewTypePlayMedia:
        {
            ...
            else
            {
                ...
                CGContextClosePath(context);
                CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0xff000000, 0.45f).CGColor);
                CGContextFillPath(context);
            }
        ...
        case TGMessageImageViewOverlayViewTypeSecretViewed:
        {
            ...
            CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0xffffffff, 0.7f).CGColor);
            CGContextFillEllipseInRect(context, CGRectMake(0.0f, 0.0f, diameter, diameter));
        ...
        case TGMessageImageViewOverlayViewTypeSecretProgress:
        {
            ...
            if (_overlayBackgroundColorHint != nil)
                ...
                CGContextSetFillColorWithColor(context, MKColorWithHexAndAlpha(0x000000, 0.48f).CGColor);
            CGContextFillEllipseInRect(context, CGRectMake(inset, inset, diameter - inset * 2.0f, diameter - inset * 2.0f));
