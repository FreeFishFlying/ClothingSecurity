...
@interface MKPhotoTextEntityView () <UITextViewDelegate>
{
    MKPaintSwatch *_swatch;
    MKPhotoPaintFont *_font;
...
@implementation MKPhotoTextEntityView
...
- (MKPhotoPaintTextEntity *)entity
{
    MKPhotoPaintTextEntity *entity = [[MKPhotoPaintTextEntity alloc] initWithText:_textView.text font:_font swatch:_swatch baseFontSize:_baseFontSize maxWidth:_maxWidth stroke:_stroke];
