...
@interface MKPhotoBrushSettingsView ()
{
    NSArray *_brushes;
    MKPaintBrushPreview *_preview;
...
@implementation MKPhotoBrushSettingsView
...
- (instancetype)initWithBrushes:(NSArray *)brushes preview:(MKPaintBrushPreview *)preview
{
    ...
    if (self != nil)
    {
        ...
        [brushes enumerateObjectsUsingBlock:^(__unused MKPaintBrush *brush, NSUInteger index, __unused BOOL *stop)
        {
...
{
    [_brushes enumerateObjectsUsingBlock:^(MKPaintBrush *aBrush, NSUInteger index, __unused BOOL *stop)
    {
...
{
    [_brushes enumerateObjectsUsingBlock:^(MKPaintBrush *aBrush, NSUInteger index, BOOL *stop)
    {
...
- (void)setInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    ...
    switch (self.interfaceOrientation)
    {
        ...
        {
            _backgroundView.image = [MKPhotoPaintSettingsView landscapeLeftBackgroundImage];
        }
            break;
            
        case UIInterfaceOrientationLandscapeRight:
        {
            _backgroundView.image = [MKPhotoPaintSettingsView landscapeRightBackgroundImage];
        }
            break;
            
        default:
        {
            _backgroundView.image = [MKPhotoPaintSettingsView portraitBackgroundImage];
        }
            break;
    }
