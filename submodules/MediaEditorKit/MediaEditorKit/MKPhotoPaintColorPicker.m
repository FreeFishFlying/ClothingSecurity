...
@interface MKPhotoPaintColorPickerKnob : UIView
{
    UIView *_wrapperView;
...
@interface MKPhotoPaintColorPicker () <UIGestureRecognizerDelegate>
{
    TGPhotoPaintColorPickerBackground *_backgroundView;
    MKPhotoPaintColorPickerKnob *_knobView;
...
@implementation MKPhotoPaintColorPicker
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        _knobView = [[MKPhotoPaintColorPickerKnob alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 24.0f, 24.0f)];
        [_knobView setColor:[MKPhotoPaintColorPicker colorForLocation:0.0f]];
...
- (MKPaintSwatch *)swatch
{
    return [MKPaintSwatch swatchWithColor:[MKPhotoPaintColorPicker colorForLocation:_location] colorLocation:_location brushWeight:_weight];
}
...
- (UIColor *)color
{
    return [MKPhotoPaintColorPicker colorForLocation:_location];
}
...
{
    _location = location;
    [_knobView setColor:[MKPhotoPaintColorPicker colorForLocation:_location]];
...
@implementation MKPhotoPaintColorPickerKnob
