...
@implementation MKPhotoPaintTextEntity
...
{
    MKPhotoPaintTextEntity *entity = [[MKPhotoPaintTextEntity alloc] initWithText:self.text font:self.font swatch:self.swatch baseFontSize:self.baseFontSize maxWidth:self.maxWidth stroke:self.stroke];
...
- (BOOL)isEqual:(id)object
{
    ...
    MKPhotoPaintTextEntity *entity = (MKPhotoPaintTextEntity *)object;
