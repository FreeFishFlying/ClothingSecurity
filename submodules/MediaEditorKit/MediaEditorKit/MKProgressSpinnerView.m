...
@interface MKProgressSpinnerView ()
{
...
@implementation MKProgressSpinnerView
...
- (void)setSucceed {
    ...
    if (_progressing)
    {
        ...
        __weak MKProgressSpinnerView *weakSelf = self;
        _internalView.onDraw = ^{
            __strong MKProgressSpinnerView *strongSelf = weakSelf;
            if (strongSelf != nil)
