...
@interface MKPhotoPaintActionsView ()
{
...
@implementation MKPhotoPaintActionsView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        [_undoButton setTitle:@"撤消" forState:UIControlStateNormal];
        ...
        [_redoButton setTitle:@"返回" forState:UIControlStateNormal];
        ...
        _clearButton.titleLabel.font = [UIFont systemFontOfSize:17];
