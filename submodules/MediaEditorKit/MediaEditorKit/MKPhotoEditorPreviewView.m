...
@interface MKPhotoEditorPreviewView ()
{
...
@implementation MKPhotoEditorPreviewView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        _imageView = [[MKPhotoEditorView alloc] initWithFrame:self.bounds];
...
- (void)setPaintingImageWithData:(MKPaintingData *)data
{
    if (data == nil)
    {
