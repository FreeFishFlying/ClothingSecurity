...
+ (void)_paintStamp:(MKPaintPoint *)point state:(TGPaintRenderState *)state
{
...
+ (void)_paintFromPoint:(MKPaintPoint *)lastLocation toPoint:(MKPaintPoint *)location state:(TGPaintRenderState *)state
{
