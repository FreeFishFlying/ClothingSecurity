...
@interface MKPhotoEditorGenericToolView ()
{
    MKPhotoEditorSliderView *_sliderView;
    UILabel *_titleLabel;
    UILabel *_valueLabel;
...
@implementation MKPhotoEditorGenericToolView
...
- (instancetype)initWithEditorItem:(id<MKPhotoEditorItem>)editorItem explicit:(bool)explicit nameWidth:(CGFloat)__unused nameWidth
{
    ...
    if (self != nil)
    {
        ...
        _sliderView = [[MKPhotoEditorSliderView alloc] initWithFrame:CGRectZero];
        ...
        __weak MKPhotoEditorGenericToolView *weakSelf = self;
        _sliderView.reset = ^
        {
            __strong MKPhotoEditorGenericToolView *strongSelf = weakSelf;
            if (strongSelf == nil)
                return;
        ...
        _titleLabel.font = [MKPhotoEditorInterfaceAssets editorItemTitleFont];
        _titleLabel.text = editorItem.title;
        _titleLabel.textAlignment = NSTextAlignmentCenter;
        _titleLabel.textColor = [MKPhotoEditorInterfaceAssets editorItemTitleColor];
        ...
        //{
            ...
            _titleLabel.textColor = editorItem.stringValue != nil ? [MKPhotoEditorInterfaceAssets editorActiveItemTitleColor] : [MKPhotoEditorInterfaceAssets editorItemTitleColor];
            ...
            _valueLabel.textColor = [MKPhotoEditorInterfaceAssets accentColor];
...
- (void)sliderValueChanged:(MKPhotoEditorSliderView *)sender
{
...
- (void)showValue
{
    ...
    _titleLabel.textColor = [MKPhotoEditorInterfaceAssets accentColor];
    _titleLabel.text = [self _value];
}
...
- (void)updateColor
{
    _titleLabel.textColor = !_explicit || _editorItem.stringValue != nil ? [MKPhotoEditorInterfaceAssets editorActiveItemTitleColor] : [MKPhotoEditorInterfaceAssets editorItemTitleColor];
}
