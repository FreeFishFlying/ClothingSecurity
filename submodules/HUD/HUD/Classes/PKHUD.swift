...
open class PKHUD: NSObject {
    ...
    internal let container = ContainerView()
    ...
    public override init() {
        ...
        container.frameView.autoresizingMask = [
            .flexibleLeftMargin,
            .flexibleRightMargin,
            .flexibleTopMargin,
    ...
    open func show(onView view: UIView? = nil, dimsBackground: Bool = true) {
        ...
        if dimsBackground && self.dimsBackground {
    ...
    @objc internal func willEnterForeground(_: Notification?) {
        startAnimatingContentView()
    }
    ...
    @objc internal func handleGraceTimer(_: Timer? = nil) {
