...
private func move(_ numbers: [CGFloat], last _: SVGCommand?, coords _: Coordinates) -> SVGCommand {
    return SVGCommand(numbers[0], numbers[1], type: .move)
}

// MARK: Ll - Line

private func line(_ numbers: [CGFloat], last _: SVGCommand?, coords _: Coordinates) -> SVGCommand {
...
private func quadBroken(_ numbers: [CGFloat], last _: SVGCommand?, coords _: Coordinates) -> SVGCommand {
...
private func cubeBroken(_ numbers: [CGFloat], last _: SVGCommand?, coords _: Coordinates) -> SVGCommand {
...
private func close(_: [CGFloat], last _: SVGCommand?, coords _: Coordinates) -> SVGCommand {
    return SVGCommand()
}
